 ...
 */
/**
 * --diff-viewport-w is the modified editor's getLayoutInfo().contentWidth,
 * so it already excludes the line-number gutter, vertical scrollbar, and
 * overview ruler. Both gutters here are just visual breathing room
